...
export default function ProfessionalSpaceTour() {
      ...
      <div className={`${isFullscreen ? 'fixed inset-0 z-40 bg-black' : ''} relative`}>
        <div className="w-full relative" style={{ height: isFullscreen ? '100vh' : '85vh' }}>
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://my.matterport.com/show/?m=JtMz7gcTyHJ&brand=0&qs=1&help=0&hr=0&sb=0&nt=0&mls=1&mt=0&search=0&kb=0&ts=0&pin=0&gt=0&st=0&ui=0&fs=0&vr=0&guides=0&title=0&lang=en"
            frameBorder="0"
            allowFullScreen
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed">
                Experience comfortable apartment living in this well-designed residential space featuring 
                modern amenities, functional layouts, and quality finishes. This comprehensive tour showcases 
                spacious living areas, comfortable bedrooms, updated kitchen and bathrooms, and thoughtful 
                design elements that create an ideal home environment for modern urban living.
              </p>
              ...
              {/* Features */}
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-white mb-6">Apartment Features</h3>
          ...
          <div className="lg:col-span-1">
            ...
            >
              <h3 className="text-xl font-bold text-white mb-6 font-outfit drop-shadow-lg">Tour Gallery</h3>
              <div className="grid grid-cols-2 gap-4 mb-8">
                {/* Harrington Apartment D03 Gallery Images */}
                <motion.div 
                  className="aspect-square bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 overflow-hidden group cursor-pointer"
                  whileHover={{ scale: 1.05 }}
                  transition={{ duration: 0.3 }}
                >
                  <Image
                    src="/Harrington-Appartments-D03-Kitchen.jpg"
                    alt="Harrington Apartment D03 Kitchen"
                    width={300}
                    height={300}
                ...
                >
                  <Image
                    src="/Harrington-Appartments-D03-Bedroom.jpg"
                    alt="Harrington Apartment D03 Bedroom"
                    width={300}
                    height={300}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                ...
                >
                  <Image
                    src="/Harrington-Appartments-D03-Bathroom.jpg"
                    alt="Harrington Apartment D03 Bathroom"
                    width={300}
                    height={300}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                ...
                >
                  <Image
                    src="/Harrington-Appartments-D03-Dining-Room.jpg"
                    alt="Harrington Apartment D03 Dining Room"
                    width={300}
                    height={300}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
              ...
              <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">Professional 3D</span>
                  </div>
                  <div className="flex justify-between">
