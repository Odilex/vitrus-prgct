...
export default function LuxurySpaceTour() {
      ...
      <div className={`${isFullscreen ? 'fixed inset-0 z-40 bg-black' : ''} relative`}>
        <div className="w-full relative" style={{ height: isFullscreen ? '100vh' : '85vh' }}>
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://my.matterport.com/show/?m=rTKvTdm7Hh3&brand=0&qs=1&help=0&hr=0&sb=0&nt=0&mls=1&mt=0&search=0&kb=0&dh=0&ts=0&pin=0&gt=0&st=0&ui=0&fs=0&vr=0&guides=0&title=0&lang=en"
            frameBorder="0"
            allowFullScreen
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed">
                Experience luxury living at its finest in this premium apartment featuring high-end finishes, 
                designer interiors, and world-class amenities that define sophisticated urban living.
              </p>
              ...
              {/* Features */}
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-white mb-6">Luxury Features</h3>
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {/* Harrington Apartment DO2 Gallery Images */}
                <motion.div 
                ...
                >
                  <Image
                    src="/Harrington-Apartments-C02-Living-Room.jpg"
                    alt="Harrington Apartment DO2 Living Room"
                    width={300}
                    height={300}
                ...
                >
                  <Image
                    src="/Harrington-Apartments-C02-Bedroom.jpg"
                    alt="Harrington Apartment DO2 Bedroom"
                    width={300}
                    height={300}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                ...
                >
                  <Image
                    src="/Harrington-Apartments-C02-Balcony.jpg"
                    alt="Harrington Apartment DO2 Balcony"
                    width={300}
                    height={300}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                ...
                >
                  <Image
                    src="/Harrington-Apartments-C02-Bedroom 1.jpg"
                    alt="Harrington Apartment DO2 Second Bedroom"
                    width={300}
                    height={300}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
              ...
              <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">Luxury 3D</span>
                  </div>
                  <div className="flex justify-between">
